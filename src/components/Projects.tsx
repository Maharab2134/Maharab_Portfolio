...
import { FaMobile, FaGlobe, FaBrain, FaGithub, FaArrowDown, FaExternalLinkAlt, FaTimes, FaMicrochip } from 'react-icons/fa';
    ...
    >
      ...
      {project.github && (
        ...
        >
          ...
          >
            {renderIcon(FaGithub as React.ComponentType<IconBaseProps>, { size: 14 })}
          </motion.span>
          Source Code
        </motion.a>
      )}
      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gray-900 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-white/10"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Header */}
            <div className="relative p-6 border-b border-white/10">
              <motion.button
                onClick={onClose}
                className="absolute p-2 text-gray-400 transition-colors rounded-full top-4 right-4 hover:text-white hover:bg-white/10"
                whileHover={{ scale: 1.1 }}
                whileTap={{ scale: 0.9 }}
              >
              {renderIcon(FaTimes as React.ComponentType<IconBaseProps>, { size: 20 })}
              </motion.button>
            ...
            <div className="p-6">
              ...
              {(project.longDescription || project.description) && (
                <div className="mb-6">
                  <h3 className="mb-3 text-xl font-semibold text-white">Project Overview</h3>
              ...
              <div className="flex gap-4">
                <motion.a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 px-6 py-3 font-medium text-white transition-colors bg-purple-500 rounded-lg hover:bg-purple-600"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  {renderIcon(FaExternalLinkAlt as React.ComponentType<IconBaseProps>, { size: 16 })}
                  Live Demo
                </motion.a>
                {project.github && (
                  <motion.a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 px-6 py-3 font-medium text-white transition-colors bg-gray-700 rounded-lg hover:bg-gray-600"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    {renderIcon(FaGithub as React.ComponentType<IconBaseProps>, { size: 16 })}
                    View Code
                  </motion.a>
                )}
              </div>
...
const ProjectGrid = ({ projects, showAll, onProjectClick }: { projects: Project[]; showAll: boolean; onProjectClick: (project: Project) => void }) => (
...
const Projects = () => {
  ...
  const appProjects: Project[] = [
    {
      ...
      description: "A full-featured e-commerce mobile application with real-time inventory management and secure payment integration.",
      ...
      technologies: ["React Native", "Node.js", "MongoDB", "Redux", "Stripe", "AR Kit", "Firebase", "Express.js"],
      image: "/images/NetBagZ.png",
    ...
    },
    {
      ...
      description: "Flutter-based personal finance management app for tracking income, expenses, and savings.",
      ...
      technologies: ["Flutter", "Firebase", "Dart", "Provider", "HTTP/Dio", "Shared Preferences", "Chart.js"],
    ...
    },
    {
      ...
      technologies: ["React Native", "Socket.io", "AWS", "GraphQL", "Node.js", "MongoDB", "Redis"],
    ...
    },
    {
      ...
      description: "On-demand food delivery platform with real-time order tracking and restaurant management.",
      ...
      technologies: ["Flutter", "Node.js", "MongoDB", "Google Maps API", "Stripe", "Firebase", "Express.js"],
    ...
    {
      title: "Smart IoT",
      description: "Flutter-based smart device controller with Bluetooth, WiFi, and cloud connectivity for real-time IoT/car control and sensor monitoring.",
      longDescription: "A cross-platform mobile app for controlling smart cars and IoT systems via multiple transports—Bluetooth, direct WiFi, and Blynk cloud. Features device discovery, real-time control interfaces, sensor dashboards, and smooth animations. Built with Flutter for robust performance on iOS and Android.",
      technologies: ["Flutter", "Dart", "Bluetooth", "WiFi TCP Socket", "Blynk", "SharedPreferences"],
      image: "/images/",
      link: "https://food-delivery.com",
      github: "https://github.com/Maharab2134/food-delivery"
    }
  ...
  const webProjects: Project[] = [
    {
      ...
      technologies: ["React", "Tailwind CSS", "Framer Motion", "TypeScript", "Vite", "ESLint"],
      image: "/images/w1.png",
    ...
    },
    {
      ...
      technologies: ["React", "Node.js", "Express", "PostgreSQL", "Socket.io", "JWT", "Chart.js"],
      image: "/images/Smart Working Habits.png",
    ...
    },
    {
      ...
      technologies: ["Next.js", "Django", "PostgreSQL", "AWS S3", "Stripe", "Redis", "Docker"],
    ...
    },
    {
      ...
      description: "A scalable e-commerce platform with product management and payment gateway integration.",
      ...
      technologies: ["React", "Node.js", "MongoDB", "Stripe", "Redux", "Express.js", "JWT"],
      image: "/images/deshiShop.png",
      link: "https://elearning.com",
      github: "https://github.com/Maharab2134/deshiShop"
    },
    {
      title: "Student Projects Platform",
      description: "A collaborative platform for students to showcase and manage academic projects.",
      ...
      technologies: ["React", "Node.js", "Express.js", "MongoDB", "Stripe", "JWT", "Multer"],
    ...
    {
      title: "FoodShare",
      description: "Platform connecting food donors with volunteers to reduce food waste and fight hunger.",
      ...
      technologies: ["React", "Node.js", "MongoDB", "Stripe", "Socket.io", "Google Maps API", "Express.js"],
      image: "/images/FS.png",
    ...
    {
      title: "PathPilot",
      description: "Intelligent career assessment platform helping users discover ideal career paths.",
      ...
      technologies: ["React", "Node.js", "Express", "TypeScript", "MongoDB", "Socket.io", "Chart.js"],
      image: "/images/PP.png",
    ...
    },
    {
      ...
      technologies: ["React", "Node.js", "MongoDB", "Three.js", "Stripe", "Express.js", "JWT"],
  ...
  const mlProjects: Project[] = [
    {
      ...
      description: "Deep learning model for image classification using transfer learning with 95% accuracy.",
      ...
      technologies: ["TensorFlow", "Python", "OpenCV", "NumPy", "Flask", "Keras", "Pandas"],
      image: "/images/Image Classification Model.png",
    ...
    },
    {
      ...
      description: "NLP-based sentiment analysis for social media content with multi-language support.",
      ...
      technologies: ["PyTorch", "NLTK", "BERT", "Python", "FastAPI", "Transformers", "Scikit-learn"],
      image: "/images/Sentiment Analysis Tool.png",
    ...
    },
    {
      ...
      technologies: ["Scikit-learn", "Pandas", "NumPy", "Flask", "Redis", "Surprise", "Matplotlib"],
    ...
    },
    {
      ...
      technologies: ["TensorFlow", "Prophet", "Pandas", "Plotly", "FastAPI", "LSTM", "Statsmodels"],
  ...
  const iotProjects: Project[] = [
    {
      ...
      description: "IoT-based smart home system with remote control, energy monitoring, and automation.",
      ...
      technologies: ["ESP32", "Arduino", "MQTT", "Node.js", "React Native", "Firebase", "Python"],
    ...
    },
    {
      ...
      description: "IoT solution for precision agriculture with soil monitoring and automated irrigation.",
      ...
      technologies: ["Raspberry Pi", "Arduino", "Python", "MQTT", "React", "MongoDB", "Django"],
    ...
    },
    {
      ...
      description: "Real-time asset tracking and monitoring system for industrial applications.",
      ...
      technologies: ["LoRaWAN", "GPS", "RFID", "Node.js", "React", "PostgreSQL", "AWS IoT"],
    ...
    },
    {
      ...
      description: "IoT wearable device for continuous health monitoring and emergency alerts.",
      ...
      technologies: ["ESP32", "Bluetooth", "Python", "React Native", "Firebase", "TensorFlow Lite", "MQTT"],
  ...
  return (
    <section id="projects" className="py-20 bg-gradient-to-b from-[#0f172a] via-[#1e293b] to-[#0f172a] relative overflow-hidden">
      <div className="relative z-10 px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-2xl mx-auto mt-3 text-lg text-gray-400">
            Explore my work across different domains of development, from mobile apps to IoT solutions
          </p>
        </motion.div>
        ...
        {sectionConfigs.map((section, i) => (
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              <span className={`text-3xl ${section.color} ${section.hoverColor} transition-colors`}>
                {renderIcon(section.icon as React.ComponentType<IconBaseProps>, { size: 28 })}
              </span>
              ...
              <div className="mt-8 text-center">
                ...
                >
                  <motion.span 
                    ...
                    transition={{ duration: 1.5, repeat: section.showAll ? 0 : Infinity }}
                  >
