...
const Admin: React.FC = () => {
  ...
  const [selectedReviewProjectFilter, setSelectedReviewProjectFilter] = useState<string>("all");
  ...
  const handleDeleteReview = async (id: string) => {
    ...
    if (!window.confirm(`Are you sure you want to permanently delete the review from "${target?.name || "this reviewer"}"?`)) return;
  ...
  // Review Reordering Handlers (Direct Up / Down / Top)
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: FaStar,
          badge: reviewsList.length > 0 ? reviewsList.length : undefined,
    ...
    <div className="min-h-screen md:h-screen md:overflow-hidden bg-[#090d16] text-slate-100 flex flex-col antialiased selection:bg-indigo-500/30 selection:text-white">
      ...
      <div className="flex-1 flex flex-col md:flex-row w-full px-4 sm:px-6 lg:px-8 py-4 sm:py-6 gap-6 lg:gap-8 max-w-[1700px] mx-auto min-h-0 md:overflow-hidden">
        ...
        <main className="flex-1 min-w-0 md:h-full md:overflow-y-auto md:pr-2 pb-16 min-h-0">
          ...
          {/* ============================================================== */}
          {/* VIEW: PROJECT REVIEWS & CLIENT EVALUATIONS */}
          {/* ============================================================== */}
          {activeTab === "reviews" && (
            <div className="space-y-6">
              {/* Header */}
              ...
              <div className="p-4 sm:p-5 rounded-2xl border border-white/[0.08] bg-gradient-to-r from-[#111726]/90 via-purple-950/25 to-[#111726]/90 backdrop-blur-md flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-lg">
                ...
                <div className="flex items-center gap-2.5 self-start sm:self-center flex-shrink-0">
                  ...
                  >
                    <span>{testimonialsToggling ? "Updating..." : testimonialsConfig.enabled ? "Make Inactive (Hide Section)" : "Make Active (Show Section)"}</span>
                  </button>
                </div>
              </div>
